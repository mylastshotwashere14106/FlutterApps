      ...
      body: GridView(
        ...
        children: [
          intentCard(
              ...
              title: 'https://celaya.tecnm.mx',
              sizeLetter: 20,
              actionFunction: openWeb),
          intentCard(
              title: 'tel:4612279093',
              icon: Icons.phone_android_rounded,
              sizeLetter: 20,
              actionFunction: callPhone),
          intentCard(
              title: 'sms:4612279093',
              icon: Icons.sms,
              sizeLetter: 20,
              actionFunction: sendSMS),
          intentCard(
              title: 'Email:ruben.torres@itcelaya.edu.mx',
              icon: Icons.email,
              sizeLetter: 15,
...
sendEmail() async {
  Uri uri = Uri(
    ...
    query: 'subject= Hola Mundo &body= Van a mimir'
  );
  if (await canLaunchUrl(uri)) {
    launchUrl(uri);
  }
